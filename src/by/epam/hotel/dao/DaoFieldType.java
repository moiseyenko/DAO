...
public enum DaoFieldType {
	ID("id"), LOGIN("login"), PASSWORD("password"), ADMIN("admin"), REMOVED("removed"), FIRST_NAME("first_name"),
	...
	ACCOUNT_ID("account_id"), CLIENT_ID("client_id"), FROM("from"), TO("to"), COST("cost");
